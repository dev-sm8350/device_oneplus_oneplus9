...
public interface IOplusRadioIndication extends IHwInterface {

    public static final String kBaseName = "android.hidl.base@1.0::IBase";
    public static final String kInterfaceName = "vendor.oplus.hardware.radio@1.0::IOplusRadioIndication";

    IHwBinder asBinder();

    public static abstract class Stub extends HwBinder implements IOplusRadioIndication {
